...
import com.zjs.edi.rocketmq.MessageListener.base.BaseExternalCallConsumer;
import com.zjs.edi.rocketmq.MessageListener.base.BaseMessageListenerConsumer;
import com.zjs.edi.rocketmq.common.ForwardedHelp;
import com.zjs.edi.rocketmq.common.HttpRequest;
import com.zjs.edi.rocketmq.pojo.HttpResponse;

/**
* <p>Title: ConsumeListConcurrentlyStatus </p>
* <p>@Description: web服务调用 消费端 </p>
* <p>Company:  </p>
* @author 李文
* @date   2016年5月30日 下午1:39:51 
*/
